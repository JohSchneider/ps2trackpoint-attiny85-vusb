...
#define  USB_CFG_VENDOR_ID       0xb3, 0x04 /* = 0x16c0 = 5824 = voti.nl */
 ...
 */
#define USB_CFG_VENDOR_NAME     'i', 'b', 'm'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'T', 'r', 'a', 'c', 'k', 'p', 'o', 'i', 'n', 't'
